(function($) {
  ...
  $(function() {
    ...
    $('#new-quote-button').on('click', function(event) {
      ...
      lastPage = document.URL; // store the pre-Ajax request URl for back/forward nav
      ...
      $.ajax({
        ...
        var post = data.shift(), // get the first and only post array
          $sourceSpan = $('.source'),
    ...
    $(window).on('popstate', function() {
      // allow Query Monitor to continue working...
